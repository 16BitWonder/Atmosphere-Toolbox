...
private:
	...
	void initCurrentLoader(std::string keyStr, u64 *key, bool *overrideByDefault, std::string allAppStr, bool *overrideAllAppByDefault, std::string MITMkeyStr, u64 *MITMkey, bool *overrideMITMByDefault, std::string CheatkeyStr, u64 *Cheatkey, bool *overrideCheatByDefault);
};
